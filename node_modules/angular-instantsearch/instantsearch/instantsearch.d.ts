...
export declare class NgAisInstantSearch implements AfterViewInit, OnInit, OnDestroy {
    ...
    refresh(): void;
    onRender: () => void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NgAisInstantSearch, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgAisInstantSearch, "ais-instantsearch", never, { "instanceName": "instanceName"; "config": "config"; }, { "change": "change"; }, never, ["*"]>;
}

//# sourceMappingURL=instantsearch.d.ts.map