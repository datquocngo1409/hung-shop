...
VgImaAdsComponent.ɵfac = function VgImaAdsComponent_Factory(t) { return new (t || VgImaAdsComponent)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(VgApiService), ɵngcc0.ɵɵdirectiveInject(VgFullscreenApiService)); };
VgImaAdsComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: VgImaAdsComponent, selectors: [["vg-ima-ads"]], hostVars: 2, hostBindings: function VgImaAdsComponent_HostBindings(rf, ctx) { if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(VgImaAdsComponent, [{
        type: Component,
        args: [{
                selector: 'vg-ima-ads',
    ...
    }], function () { return [{ type: ElementRef }, { type: VgApiService }, { type: VgFullscreenApiService }]; }, { onAdStart: [{
            type: Output
        }], onAdStop: [{
            type: Output
        }], onSkipAd: [{
...
VgImaAdsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function VgImaAdsModule_Factory(t) { return new (t || VgImaAdsModule)(); }, imports: [[CommonModule, VgCoreModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(VgImaAdsModule, { declarations: function () { return [VgImaAdsComponent]; }, imports: function () { return [CommonModule, VgCoreModule]; }, exports: function () { return [VgImaAdsComponent]; } }); })();
