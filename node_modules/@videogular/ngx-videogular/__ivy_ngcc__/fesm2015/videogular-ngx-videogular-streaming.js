...
VgDashDirective.ɵfac = function VgDashDirective_Factory(t) { return new (t || VgDashDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(VgApiService)); };
VgDashDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: VgDashDirective, selectors: [["", "vgDash", ""]], inputs: { vgDash: "vgDash", vgDRMToken: "vgDRMToken", vgDRMLicenseServer: "vgDRMLicenseServer" }, outputs: { onGetBitrates: "onGetBitrates" }, exportAs: ["vgDash"], features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(VgDashDirective, [{
        type: Directive,
        args: [{
                selector: '[vgDash]',
                exportAs: 'vgDash'
            }]
    }], function () { return [{ type: ElementRef }, { type: VgApiService }]; }, { onGetBitrates: [{
            type: Output
        }], vgDash: [{
            type: Input
        }], vgDRMToken: [{
...
VgHlsDirective.ɵfac = function VgHlsDirective_Factory(t) { return new (t || VgHlsDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(VgApiService)); };
VgHlsDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: VgHlsDirective, selectors: [["", "vgHls", ""]], inputs: { vgHlsHeaders: "vgHlsHeaders", vgHls: "vgHls" }, outputs: { onGetBitrates: "onGetBitrates" }, exportAs: ["vgHls"], features: [ɵngcc0.ɵɵNgOnChangesFeature] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(VgHlsDirective, [{
        type: Directive,
        args: [{
                selector: '[vgHls]',
                exportAs: 'vgHls'
            }]
    }], function () { return [{ type: ElementRef }, { type: VgApiService }]; }, { vgHlsHeaders: [{
            type: Input
        }], onGetBitrates: [{
            type: Output
        }], vgHls: [{
...
VgStreamingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function VgStreamingModule_Factory(t) { return new (t || VgStreamingModule)(); }, imports: [[CommonModule, VgCoreModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(VgStreamingModule, { declarations: function () { return [VgDashDirective, VgHlsDirective]; }, imports: function () { return [CommonModule, VgCoreModule]; }, exports: function () { return [VgDashDirective, VgHlsDirective]; } }); })();
