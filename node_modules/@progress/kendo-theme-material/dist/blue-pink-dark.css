...
.k-slider .k-draghandle:focus, .k-slider .k-draghandle.k-state-focused {
  box-shadow: 0 0 0 11px rgba(33, 150, 243, 0.25);
}
...
.k-calendar.k-calendar-range .k-range-end,
.k-calendar.k-calendar-range .k-range-mid {
  background-image: linear-gradient(transparent 1px, rgba(33, 150, 243, 0.25) 1px, rgba(33, 150, 243, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar.k-calendar-range .k-range-split-start::after {
  left: -5px;
  right: auto;
  background-image: linear-gradient(to left, rgba(33, 150, 243, 0.25), transparent 100%);
}

.k-calendar.k-calendar-range .k-range-split-end::after {
  right: -5px;
  left: auto;
  background-image: linear-gradient(to right, rgba(33, 150, 243, 0.25), transparent 100%);
}
...
.k-rating:focus .k-rating-item.k-state-selected > .k-icon, .k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(33, 150, 243, 0.4);
}
...
.k-spreadsheet-active-cell.k-right {
  box-shadow: inset 0 0 0 1px #2196f3, inset -1px 0 0 1px #2196f3;
}

.k-spreadsheet-active-cell.k-bottom {
  box-shadow: inset 0 0 0 1px #2196f3, inset 0 -1px 0 1px #2196f3;
}

.k-spreadsheet-active-cell.k-bottom.k-right {
  box-shadow: inset 0 0 0 1px #2196f3, inset -1px -1px 0 1px #2196f3;
}
