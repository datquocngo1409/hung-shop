...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(25, 132, 200, 0.3) 1px, rgba(25, 132, 200, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  ...
  background-color: rgba(25, 132, 200, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(25, 132, 200, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(25, 132, 200, 0.3), transparent);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(25, 132, 200, 0.5);
}
.k-rating-item {
  color: #dedee0;
}
...
.k-stepper .k-step-link:focus .k-step-label:only-child {
  box-shadow: inset 0 0 0 2px #dedee0;
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #d92800 2px, #d92800 4px);
}
.k-task-offset .k-resize-handle::after {
  background-color: #000000;
}
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #e15333 2px, #e15333 4px);
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(25, 132, 200, 0.2);
}
...
.k-footer-template .k-grid-footer-sticky {
  border-left-color: #8e8e97;
  border-right-color: #8e8e97;
}
.k-grid-header-locked,
.k-grid-content-locked,
