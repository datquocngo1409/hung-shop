...
.k-chat .k-toolbar-box .k-scroll-button {
  background-color: #1b141a;
  box-shadow: 0 0 20px 5px #1b141a;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(135, 0, 116, 0.3) 1px, rgba(135, 0, 116, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  ...
  background-color: rgba(135, 0, 116, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(135, 0, 116, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(135, 0, 116, 0.3), transparent);
}
...
.k-switch-on .k-switch-handle {
  ...
  background-image: url(textures/glass-lighter.png);
  background-image: url(textures/glass-lighter.png), linear-gradient(to bottom, rgba(255, 255, 255, 0.12) 0%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0) 100%);
}
.k-switch-on:focus,
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(135, 0, 116, 0.5);
}
.k-rating-item {
  color: #674c63;
}
...
.k-stepper .k-step-indicator::after {
  box-shadow: inset 0 0 0 2px #1b141a;
}
...
.k-stepper .k-step-link:focus .k-step-label:only-child {
  box-shadow: inset 0 0 0 2px #674c63;
}
...
.k-textarea.ng-invalid.ng-dirty {
  border-color: rgba(227, 58, 19, 0.5);
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #e33a13 2px, #e33a13 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #e33a13 2px, #e33a13 4px);
}
.k-task-offset .k-resize-handle::after {
  background-color: #000000;
}
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #e96142 2px, #e96142 4px);
}
...
.k-summary-wrap .k-task-offset:after {
  border-color: transparent;
  border-right-color: #e33a13;
}
.k-rtl .k-summary-wrap .k-task-offset:before {
  border-color: transparent;
  border-left-color: #e33a13;
}
...
.k-spreadsheet .k-spreadsheet-has-comment:after {
  border-color: #870074 #870074 transparent transparent;
}
.k-spreadsheet .k-dirty {
  border-color: #e33a13 transparent transparent #e33a13;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(135, 0, 116, 0.2);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #870074 transparent transparent #870074;
}
.k-rtl .k-spreadsheet .k-dirty {
  border-color: #e33a13 #e33a13 transparent transparent;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #1b141a;
}
...
.k-dropdowngrid-popup .k-item.k-state-selected {
  background-image: linear-gradient("rgba(255,255,255,.3) 0%, rgba(255,255,255,.1) 100%");
  border-color: #674c63;
  color: #fff;
  background-color: #870074;
}
...
.k-footer-template .k-grid-footer-sticky {
  border-left-color: #b499b0;
  border-right-color: #b499b0;
}
.k-grid-header-locked,
.k-grid-content-locked,
