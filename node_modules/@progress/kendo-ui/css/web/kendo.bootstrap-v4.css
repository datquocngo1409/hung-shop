...
.k-autocomplete.k-header.k-invalid:focus,
.k-autocomplete.k-header.k-invalid.k-state-focused,
.k-autocomplete.k-header.k-invalid:hover:focus,
.k-autocomplete.k-header.k-invalid:hover.k-state-focused,
.k-autocomplete.k-header.k-state-invalid:focus,
.k-autocomplete.k-header.k-state-invalid.k-state-focused,
.k-autocomplete.k-header.ng-invalid.ng-touched:focus,
.k-autocomplete.k-header.ng-invalid.ng-touched.k-state-focused,
.k-autocomplete.k-header.ng-invalid.ng-dirty:focus,
...
.k-autocomplete.k-invalid:hover:focus,
.k-autocomplete.k-invalid:hover.k-state-focused,
...
.k-autocomplete.ng-invalid.ng-dirty:focus,
...
.k-grid-header .k-header-column-menu {
  ...
  position: absolute;
  right: 0.5rem;
  bottom: calc(0.75rem + 0.75em - 0.75em - 0.375rem);
  z-index: 1;
}
