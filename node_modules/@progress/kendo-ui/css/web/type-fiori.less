...
@button-background-color: lighten(@base, 2%);
@button-border-color: darken(@base, 20%);
...
@button-focused-active-shadow: null;
// Primary button
@primary-text-color: @background;
@primary-background-color: lighten(@accent, 10%);
...
@primary-focused-shadow: null;
@primary-focused-active-shadow: null;
...
@tooltip-border: darken(@background, 25%);
...
//TileLayout
@tilelayout-bg: darken(@background, 5%);
...
@grid-selected-bg: desaturate(@selected-secondary-background-color, 5%);
...
@grid-selected-hover-bg: darken(@selected-secondary-background-color, 3%);
...
@calendar-header-cell-bg: transparent;
...
@calendar-weekend-cell-bg: contrast(@calendar-bg, lighten(@calendar-bg, 10), darken(@calendar-bg, 10), .5);
...
@calendar-cell-focused-shadow: inset 0 0 0px 1px @accent;
...
@window-titlebar-bg: null;
@window-titlebar-text: null;
...
@switch-on-hovered-border: @button-focused-border-color;
...
@rating-icon-selected-text: @primary-background-color;
@rating-icon-hover-text: @primary-background-color;
@rating-icon-focused-text: @primary-background-color;
...
@checkbox-border: contrast(@input-bg, darken(@input-bg, 40%), lighten(@input-bg, 40%));
@checkbox-hovered-bg: @checkbox-bg;
@checkbox-hovered-text: @checkbox-text;
@checkbox-hovered-border: @checkbox-hovered-text;
...
@filemanager-listview-item-icon-selected-text: @widget-text-color;
...
@gantt-task-completed-selected-bg: @selected-background-color;
@gantt-summary-completed-selected-bg: @primary-active-background-color;
...
.k-calendar {
    ...
    td {
        background-color: contrast(@base, lighten(@calendar-bg, 4), darken(@calendar-bg, 4), .5)
    }
    .k-content {
        border-spacing: 1px;
    }
