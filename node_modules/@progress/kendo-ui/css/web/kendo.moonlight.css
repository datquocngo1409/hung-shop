...
.ktb-var-hover-gradient {
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), linear-gradient(to bottom, rgba(255,255,255,.25) 0%, rgba(255,255,255,0) 100%);
}
...
.ktb-var-selected-gradient {
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), linear-gradient(to bottom, #f4af03 0%, #ee9f05 100%);
}
...
.k-chat .k-toolbar-box .k-scroll-button {
  background-color: #414550;
  box-shadow: 0 0 20px 5px #414550;
}
...
.k-calendar td.k-state-focused .k-link {
  box-shadow: inset 0 0 2px 1px #fdd060;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(244, 175, 3, 0.3) 1px, rgba(244, 175, 3, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  ...
  background-color: rgba(244, 175, 3, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(244, 175, 3, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(244, 175, 3, 0.3), transparent);
}
...
.k-switch-on .k-switch-handle {
  ...
  background-color: #f4af03;
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), linear-gradient(to bottom, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0) 100%);
}
.k-switch-on:focus,
...
.k-switch-on.k-state-hover .k-switch-handle {
  ...
  background-color: #f4af03;
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), linear-gradient(to bottom, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0) 100%);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(244, 175, 3, 0.5);
}
.k-rating-item {
  color: #fff;
}
...
.k-toolbar {
  ...
  color: #fff;
  background-color: #1f2a35;
  background-image: linear-gradient("rgba(255,255,255,.2) 0%, rgba(255,255,255,.1) 100%");
}
...
.k-window {
  ...
  color: #fff;
  background-color: #414550;
  box-shadow: 1px 1px 7px 1px rgba(255, 255, 255, 0.12);
}
.k-window.k-state-focused {
  border-color: #232d36;
  box-shadow: 1px 1px 7px 1px rgba(255, 255, 255, 0.25);
}
.k-window-titlebar {
  border-top-left-radius: 2px;
  border-top-right-radius: 2px;
...
.k-stepper .k-step-indicator::after {
  box-shadow: inset 0 0 0 2px #414550;
}
...
.k-stepper .k-step-link:focus .k-step-label:only-child {
  box-shadow: inset 0 0 0 2px #232d36;
}
...
.k-textarea.ng-invalid.ng-dirty {
  border-color: rgba(190, 81, 56, 0.5);
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #be5138 2px, #be5138 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #be5138 2px, #be5138 4px);
}
.k-task-offset .k-resize-handle::after {
  background-color: #000000;
}
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #cb7460 2px, #cb7460 4px);
}
...
.k-drop-hint-h .k-drop-hint-start {
  border-left-color: #f4af03;
}
.k-drop-hint-h .k-drop-hint-end {
  border-right-color: #f4af03;
}
.k-drop-hint-v .k-drop-hint-start {
  border-top-color: #f4af03;
}
...
.k-spreadsheet .k-spreadsheet-has-comment:after {
  border-color: #f4af03 #f4af03 transparent transparent;
}
.k-spreadsheet .k-dirty {
  border-color: #be5138 transparent transparent #be5138;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(244, 175, 3, 0.2);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #f4af03 transparent transparent #f4af03;
}
.k-rtl .k-spreadsheet .k-dirty {
  border-color: #be5138 #be5138 transparent transparent;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #4a4f5b;
}
...
.k-dropdowngrid-popup .k-item.k-state-selected {
  background-image: linear-gradient("#f4af03 0%, #ee9f05 100%");
  border-color: #232d36;
  color: #171e28;
  background-color: #f4af03;
}
