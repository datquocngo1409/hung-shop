...
.k-split-button-expanded .k-i-arrow-60-down, .k-split-button-expanded .k-i-arrow-s::before, .k-split-button-expanded .k-i-sarrow-s::before, .k-split-button-expanded .k-i-collapse::before, .k-split-button-expanded .k-i-expand-s::before,
