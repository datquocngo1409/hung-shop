...
.ktb-var-normal-gradient {
  ...
  background-image: url('textures/glass.png'), linear-gradient(to bottom, rgba(255,255,255,0) 0%, rgba(255,255,255,.0) 50%, rgba(255,255,255,.0) 100%);
}
...
.ktb-var-selected-gradient {
  background-image: url('textures/glass.png');
  background-image: url('textures/glass.png'), linear-gradient(to bottom, rgba(255,255,255,.08) 0%, rgba(255,255,255,.08) 50%, rgba(255,255,255,.0) 100%);
}
...
.k-calendar td.k-state-focused .k-link {
  box-shadow: inset 0 0 2px 1px #3399ff;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(0, 102, 204, 0.3) 1px, rgba(0, 102, 204, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(0, 102, 204, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(0, 102, 204, 0.3), transparent);
}
...
.k-switch-on .k-switch-handle {
  ...
  background-color: #0066cc;
  background-image: url('textures/glass.png');
  background-image: url('textures/glass.png'), linear-gradient(to bottom, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0) 100%);
}
.k-switch-on:focus,
...
.k-switch-on.k-state-hover .k-switch-handle {
  ...
  background-color: #0066cc;
  background-image: url('textures/glass.png');
  background-image: url('textures/glass.png'), linear-gradient(to bottom, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0) 100%);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(0, 102, 204, 0.5);
}
.k-rating-item {
  color: #fff;
}
...
.k-toolbar {
  ...
  color: #fff;
  background-color: #292525;
  background-image: linear-gradient("rgba(255,255,255,0) 0%, rgba(255,255,255,.0) 50%, rgba(255,255,255,.0) 100%");
}
...
.k-spreadsheet .k-spreadsheet-has-comment:after {
  border-color: #0066cc #0066cc transparent transparent;
}
...
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #0066cc transparent transparent #0066cc;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #575757;
}
...
.k-dropdowngrid-popup .k-item.k-state-selected {
  background-image: linear-gradient("rgba(255,255,255,.08) 0%, rgba(255,255,255,.08) 50%, rgba(255,255,255,.0) 100%");
  border-color: #2a2a2a;
  color: #fff;
  background-color: #0066cc;
}
