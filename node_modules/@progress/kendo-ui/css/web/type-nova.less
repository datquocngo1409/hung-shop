...
// Toolbar
@toolbar-bg: @widget-background-color;
...
//TileLayout
@tilelayout-bg: darken(@background, 4%);
...
@grid-selected-hover-bg: lighten(@info, 17%);
...
// Tooltip
@tooltip-border-radius: @inputs-border-radius;
@tooltip-shadow: @widget-shadow;

@tooltip-bg: @widget-background-color;
@tooltip-text: @normal-text-color;
@tooltip-border: @widget-border-color;
...
//Gantt
@event-text-color: @inversed-text-color;
@gantt-task-selected-bg: lighten(@info, 4%);
@gantt-task-completed-selected-bg: darken(@info, 21%);
@gantt-summary-completed-selected-bg: lighten(@info, 22%);
