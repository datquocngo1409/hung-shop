...
.k-chat .k-toolbar-box .k-scroll-button {
  background-color: #0e0e0e;
  box-shadow: 0 0 20px 5px #0e0e0e;
}
...
.k-calendar .k-today .k-link {
  color: #008886;
  box-shadow: inset 0 0 0 1px #008886;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(0, 136, 134, 0.3) 1px, rgba(0, 136, 134, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  background-image: none;
  background-color: rgba(0, 136, 134, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(0, 136, 134, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(0, 136, 134, 0.3), transparent);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(0, 136, 134, 0.5);
}
.k-rating-item {
  color: #fff;
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #e20000 2px, #e20000 4px);
}
...
.k-drop-hint-h .k-drop-hint-start {
  border-left-color: #008886;
}
.k-drop-hint-h .k-drop-hint-end {
  border-right-color: #008886;
}
.k-drop-hint-v .k-drop-hint-start {
  border-top-color: #008886;
}
.k-drop-hint-v .k-drop-hint-end {
  border-bottom-color: #008886;
}
.k-scheduler {
  color: #ffffff;
  background-color: #0e0e0e;
...
.k-spreadsheet .k-spreadsheet-has-comment:after {
  border-color: #00aba9 #00aba9 transparent transparent;
}
.k-spreadsheet .k-dirty {
  border-color: #ff3030 transparent transparent #ff3030;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(0, 171, 169, 0.2);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #00aba9 transparent transparent #00aba9;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #0e0e0e;
}
