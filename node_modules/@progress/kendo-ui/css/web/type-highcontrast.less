...
@button-hover-background-color: lighten(@hover-background, 5%);
@button-hover-border-color: @hover-background;
@button-hover-gradient: none;
@button-hover-shadow: null;
@button-active-background: @accent;
@button-active-text-color: @selected-text-color;
@button-active-border-color: @hover-background;
@button-active-gradient: none;
@button-active-shadow: null;
@button-focused-border-color: @normal-text-color;
@button-focused-shadow: 0 0 3px 1px #fff;
@button-focused-active-shadow: 0 0 3px 1px #fff;
// Primary button
@primary-text-color: @normal-text-color;
@primary-background-color: @hover-background;
@primary-border-color: @hover-background;
@primary-gradient: none;
@primary-shadow: null;
@primary-hover-text-color: @normal-text-color;
@primary-hover-background-color: lighten(@hover-background, 5%);
...
@primary-active-border-color: @hover-background;
...
@notification-info-text: contrast( @notification-info-bg );
@notification-info-border: @info;
@notification-success-bg: @success;
@notification-success-text: contrast( @notification-success-bg );
@notification-success-border: @success;
@notification-warning-bg: @warning;
@notification-warning-text: contrast( @notification-warning-bg );
@notification-warning-border: @warning;
@notification-error-bg: @error;
@notification-error-text: contrast( @notification-error-bg );
...
@tooltip-bg: @base;
@tooltip-text: @normal-text-color;
@tooltip-border: darken(@normal-text-color, 21%);
...
@grid-sticky-border: lighten(@grid-border, 30%);

@grid-selected-hover-bg: lighten(@hover-background, 7%);
...
@switch-container-hovered-shadow: none;
...
@switch-on-focused-border: @button-focused-border-color;
...
@switch-on-handle-bg: lighten(@background, 6%);
@switch-on-handle-text: @switch-on-text;
@switch-on-handle-border: @button-border-color;
@switch-on-handle-gradient: rgba(255,255,255,0.12) 0%,rgba(255,255,255,0.05) 50%,rgba(255,255,255,0) 100%;
...
@switch-off-focused-border: @button-focused-border-color;
...
// Adaptive Grid
@adaptive-grid-sort-text: @hover-background;

// Adaptive Scheduler
@adaptive-scheduler-current-text: lighten(@accent, 20%);
...
@checkbox-bg: @normal-background;
@checkbox-text: @normal-text-color;
@checkbox-border: @normal-text-color;
...
@checkbox-focused-border: @checkbox-border;
@checkbox-focused-shadow: 0 0 3px 0 @checkbox-text;
@checkbox-focused-checked-border: @checkbox-border;
@checkbox-focused-checked-shadow: 0 0 3px 0 @checkbox-text;
...
@stepper-label-success-text: #fff;
@stepper-label-error-text: @error;
...
@gantt-task-completed-selected-bg: darken(@event-background-color, 15%);
...
.k-task-complete
{
    ...
    background: darken(@event-background-color, 15%);
    color: @event-text-color;
}
...
.k-gantt-planned .k-task-offset-wrap .k-task-single,
.k-gantt-planned .k-task-offset-wrap .k-task-complete
{
    border-bottom-right-radius: 0;
    border-top-right-radius: 0;
}

.k-gantt-planned .k-task-offset
{
    border-bottom-right-radius: @inner-border-radius;
    border-top-right-radius: @inner-border-radius;
}

.k-rtl .k-gantt-planned .k-task-offset-wrap .k-task-single,
.k-rtl .k-gantt-planned .k-task-offset-wrap .k-task-complete
{
...
.k-rtl .k-gantt-planned .k-task-offset
{
    border-bottom-right-radius: 0;
    border-top-right-radius: 0;
    border-bottom-left-radius: @inner-border-radius;
...
.k-time-list-wrapper {
    ...
    .k-title {
        ...
        .composite-background(@header-gradient);
