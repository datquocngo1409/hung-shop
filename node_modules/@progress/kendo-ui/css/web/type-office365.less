...
@button-hover-background-color: darken(@hover-background, 7%);
...
@primary-active-border-color: darken(@primary-active-background-color, 2%);
@primary-active-gradient: null;
@primary-active-shadow: null;
@primary-focused-border-color: darken(@primary-active-background-color, 2%);
...
@tooltip-border: darken(@background, 21%);
...
//TileLayout
@tilelayout-bg: darken(@background, 3%);
...
@grid-selected-hover-bg: desaturate(@selected-background-color, 35%);
...
@calendar-week-cell-bg: contrast(@calendar-bg, lighten(@calendar-bg, 8), darken(@calendar-bg, 8), .5);
...
@calendar-cell-focused-shadow: inset 0 0 0px 1px @base;
...
@switch-on-text: @normal-text-color;
@switch-on-border: darken(@background, 27%);
...
@switch-on-hovered-border: darken(@background, 44%);
...
@switch-off-handle-hovered-bg: darken(@background, 8%);
@switch-off-handle-hovered-text: @switch-off-text;
@switch-off-handle-hovered-border: @switch-off-handle-hovered-bg;
...
@drawer-focused-shadow: inset 0 0 0 1px @focused-border-color;
...
// Filter
@filter-preview-field-text: @base;
...
@timeline-flag-background: @base;
@timeline-flag-text: contrast(@base);

@timeline-circle-color: @base;
...
@import "Office365/chat/_theme.less";
...
.k-pager-wrap {
    ...
    .k-pager-numbers .k-state-selected {
        border-top-color: @link-text-color;
        color: @link-text-color;
    }
}
