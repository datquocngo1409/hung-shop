...
.k-button.k-state-hover {
  color: #fff;
  border-color: #12d7c3;
  background-color: #12d7c3;
}
.k-button:active,
.k-button.k-state-active,
.k-button.k-state-selected {
  color: #fff;
  background-color: #0eb1a1;
  border-color: #0eb1a1;
}
...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(16, 196, 178, 0.3) 1px, rgba(16, 196, 178, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  background-image: none;
  background-color: rgba(16, 196, 178, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(16, 196, 178, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(16, 196, 178, 0.3), transparent);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(16, 196, 178, 0.5);
}
.k-rating-item {
  color: #cccccc;
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #fe633f 2px, #fe633f 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #fe633f 2px, #fe633f 4px);
}
.k-task-offset .k-resize-handle::after {
  background-color: #000000;
}
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #fe8265 2px, #fe8265 4px);
}
...
.k-drop-hint-h .k-drop-hint-start {
  border-left-color: #10c4b2;
}
.k-drop-hint-h .k-drop-hint-end {
  border-right-color: #10c4b2;
}
...
.k-spreadsheet .k-spreadsheet-has-comment:after {
  border-color: #10c4b2 #10c4b2 transparent transparent;
}
.k-spreadsheet .k-dirty {
  border-color: #fe633f transparent transparent #fe633f;
}
...
.k-spreadsheet-drawing-anchor-cell {
  background: rgba(16, 196, 178, 0.2);
}
.k-rtl .k-spreadsheet .k-spreadsheet-has-comment::after {
  border-color: #10c4b2 transparent transparent #10c4b2;
}
...
.k-time-list::before,
.k-time-list::after {
  box-shadow: 0 0 3em 1.5em #363940;
}
