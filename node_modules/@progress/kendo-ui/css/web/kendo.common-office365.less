...
@gantt-planned-dependency-margin-y: .5em;
@gantt-planned-resource-margin-y: 0.9em;
@gantt-planned-dot-margin-y: 1.3em;
...
@gantt-task-offset-line-height: inherit;
@gantt-offset-height: 1.85em;
