...
@filter-icon-size: calc(2.71428571em + 2px); // dropdown select button width including borders
...
@menu-vertical-link-padding: 3em;
...
@horizontal-form-label-padding-top: 8px;
...
@grid-th-padding: .929em .6em .714em .6em;
...
@grid-header-padding-y: (@grid-padding-y / 2);
...
@calendar-header-padding-x: 6px;
@calendar-header-padding-y: 6px;
@calendar-header-border-width: 0;
@calendar-header-button-padding-x: 8px;
@calendar-header-button-padding-y: 8px;
...
@pdf-viewer-search-dialog-input-button-height: @input-offset;
...
@filter-operator-dropdown-width: 15.5em;
...
@breadcrumb-link-line-height: 1.7em;
...
// Gantt
@gantt-planned-row-height: 3.8em;

@gantt-planned-margin-y: .35em;
@gantt-planned-milestone-margin-y: .75em;
@gantt-planned-summary-margin-y: .75em;
@gantt-planned-border-width: 2px;
@gantt-planned-line-height: .75em;

@gantt-planned-dependency-margin-y: .8em;
...
.k-filtercell > span {
    padding-right: calc(@filter-icon-size * 2 + 4px); // width of 2 filter buttons + 4px spacing
}

.k-filtercell > .k-operator-hidden {
    padding-right: calc(@filter-icon-size + 2px); // width of 1 filter button + 2px spacing
}
...
.k-filter-row {
  ...
  .k-button-icon {
    ...
    right: calc(@filter-icon-size + 2px); // width of the button + 2px
    height: 100%;
    border-radius: 0;
  }
}
...
[dir="rtl"] {
    ...
    .k-panelbar .k-panelbar-expand.k-icon,
    .k-panelbar .k-panelbar-collapse.k-icon {
        left: auto;
        right: 9px;
    }
    ...
    .k-filter-row {
        .k-filtercell {
            & > span {
                padding-left: calc(@filter-icon-size * 2 + 4px); // width of 2 filter buttons + 4px spacing
                padding-right: 0;
            ...
            & > .k-operator-hidden {
                padding-left: calc(@filter-icon-size + 2px); // width of 1 filter button + 2px spacing
                padding-right: 0;
            }

            .k-dropdown-operator,
            .k-button-icon {
                left: calc(@filter-icon-size + 2px); // width of the button + 2px
                right: auto;
            }
        }
    }
...
.k-pager-wrap {
    ...
    .k-pager-numbers-wrap {
        margin-top: -@pager-padding-y;
        margin-bottom: -@pager-padding-y;
        align-self: stretch;
    }
    .k-pager-numbers {
        align-self: stretch;
