...
@combobox-clear-icon-offset: ~"( 2.57142857em + ((2.56428571em - @{grid-size})/2) )";
...
@grid-th-padding: .786em .6em .786em 1.286em;
...
@window-titlebar-padding-x: 16px;
@window-titlebar-padding-y: 10px;
@window-titlebar-border-width: 0;
@window-titlebar-border-style: none;
...
@calendar-header-padding-x: 0;
@calendar-header-padding-y: 0;
@calendar-header-border-width: 0;
@calendar-header-button-padding-x: 1em;
@calendar-header-button-padding-y: 1em;
...
@calendar-cell-line-height: (22 / 14);
@calendar-cell-size: ( (38px / 14px ) * 1em );
...
@switch-label-outer-spacing: 12px;
...
@timeline-card-callout-width: 20px;
@timeline-card-callout-height: 20px;
...
// Gantt
@gantt-planned-row-height: 4.8em;

@gantt-planned-margin-y: .35em;
@gantt-planned-milestone-margin-y: 1em;
@gantt-planned-summary-margin-y: 1em;
...
@gantt-planned-dot-margin-y: 1.6em;
@gantt-planned-dot-summary-milestone-margin-y: 1.6em;
...
.k-edit-form-container .k-breadcrumb .k-button {
    padding: @button-padding-y (@button-padding-x / 2);
}
