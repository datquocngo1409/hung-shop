...
.k-toolbar {
  ...
  color: #676767;
  background-color: #ffffff;
  background-image: linear-gradient("rgba(0,0,0,.01) 0%, rgba(0,0,0,.08) 100%");
}
...
.k-dropdowngrid-popup .k-item.k-state-hover {
  background-image: linear-gradient("rgba(0,0,0,.01) 0%, rgba(0,0,0,.06) 100%");
  border-color: #ebebeb;
  color: #676767;
  background-color: #fff;
}
.k-dropdowngrid-popup .k-item.k-state-selected {
  background-image: linear-gradient("rgba(0,0,0,.13) 0%, rgba(0,0,0,.08) 100%");
  border-color: #ebebeb;
  color: #454545;
  background-color: #eee;
}
