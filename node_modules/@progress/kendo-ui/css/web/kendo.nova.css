...
.k-calendar-range td.k-range-end {
  background-image: linear-gradient(transparent 1px, rgba(93, 213, 228, 0.3) 1px, rgba(93, 213, 228, 0.3) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-edge .k-calendar-range td.k-range-end {
  background-image: none;
  background-color: rgba(93, 213, 228, 0.3);
}
.k-calendar-range td.k-range-split-start::after {
  background-image: linear-gradient(to left, rgba(93, 213, 228, 0.3), transparent);
}
.k-calendar-range td.k-range-split-end::after {
  background-image: linear-gradient(to right, rgba(93, 213, 228, 0.3), transparent);
}
...
.k-rating.k-state-focused .k-rating-item.k-state-selected > .k-icon {
  text-shadow: 0 2px 3.6px rgba(255, 67, 80, 0.5);
}
.k-rating-item {
  color: #e0e0e0;
}
...
.k-checkbox:checked:focus {
  box-shadow: 0 0 0 2px rgba(255, 67, 80, 0.3);
  border-color: #ff4350;
}
.k-radio {
  border-color: #e0e0e0;
...
.k-textarea.ng-invalid.ng-dirty {
  border-color: rgba(255, 38, 55, 0.5);
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #ff2637 2px, #ff2637 4px);
}
...
.k-task-offset {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #ff2637 2px, #ff2637 4px);
}
.k-task-offset .k-resize-handle::after {
  background-color: #000000;
}
.k-task-offset:hover {
  background-image: repeating-linear-gradient(135deg, #FFF, #FFF 2px, #ff515f 2px, #ff515f 4px);
}
...
.k-state-selected {
  background-color: rgba(30, 162, 179, 0.25);
}
.k-state-focused {
...
.k-grid .k-button-icontext:active {
  color: #ffffff;
  background-color: #ff4350;
  border-color: #ff4350;
}
...
.k-edit-form-container :not(.k-button-group) > .k-button {
  color: #32364c;
...
.k-edit-form-container :not(.k-button-group) > .k-primary {
  color: #ff4350;
}
.k-filter-menu .k-primary {
  border-left-color: #e0e0e0;
...
.k-spreadsheet .k-dirty {
  border-color: #a5000d transparent transparent #a5000d;
}
...
.k-rtl .k-spreadsheet .k-dirty {
  border-color: #a5000d #a5000d transparent transparent;
}
