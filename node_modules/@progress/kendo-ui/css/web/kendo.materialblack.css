...
.k-chat .k-toolbar-box .k-scroll-button {
  background-color: #363636;
  box-shadow: 0 0 20px 5px #363636;
}
...
.k-task-delayed.k-task-milestone {
  border-color: transparent;
  background-image: repeating-linear-gradient(90deg, #FFFFFF, #FFFFFF 2px, #f44336 2px, #f44336 4px);
}
...
.k-split-button:focus > .k-button,
.k-split-button.k-state-focus > .k-button {
  color: #d5d5d5;
  border-color: #737373;
  background-color: #737373;
}
