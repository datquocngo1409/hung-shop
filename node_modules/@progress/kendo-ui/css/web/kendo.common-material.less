...
@calendar-border-radius: 100px;
@calendar-font-size: 14px;
@calendar-line-height: (20 / 14);

@calendar-header-padding-x: 4px;
@calendar-header-padding-y: 4px;
...
@calendar-cell-padding-x: .65em;
@calendar-cell-padding-y: .65em;
...
// Pager -- old vars
@pager-button-border-radius-sm: 2px;
...
@pdf-viewer-search-dialog-spacing: 0.42857143em;
...
@breadcrumb-link-line-height: 1.45em;
...
@gantt-planned-dependency-margin-y: 0.5em;
...
[dir="rtl"] {
    ...
    .k-menu {
        .k-menu-group,
        &.k-menu-vertical  {
            .k-item > .k-link > .k-menu-expand-arrow {
                right: auto;
                left: 1.071em;
            }
        }
