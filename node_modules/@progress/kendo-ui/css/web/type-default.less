...
@notification-info-border: @notification-info-bg;
@notification-success-bg: @success;
@notification-success-text: contrast( @notification-success-bg );
@notification-success-border: @notification-success-bg;
@notification-warning-bg: @warning;
@notification-warning-text: contrast( @notification-warning-bg );
@notification-warning-border: @notification-warning-bg;
@notification-error-bg: @error;
@notification-error-text: contrast( @notification-error-bg );
@notification-error-border: @notification-error-bg;
@notification-gradient: rgba(255,255,255,.25) 0%, rgba(255,255,255,0) 100%;


// Tooltip
@tooltip-border-radius: @border-radius;
@tooltip-shadow: 0 4px 6px @shadow-color;

@tooltip-bg: @header-background-color;
@tooltip-text: @header-text-color;
@tooltip-border: @secondary-border-color;
...
@grid-selected-hover-bg: saturate(@selected-background-color, 7%);
...
@window-titlebar-gradient: rgba(white, .25), rgba(white, 0);
...
// Badge
@badge-secondary-bg: darken(@base, 4%);
...
@checkbox-focused-checked-border: @checkbox-text;
...
@stepper-label-error-text: contrast(@hover-background, lighten(@error, 15%), darken(@error, 4%));
