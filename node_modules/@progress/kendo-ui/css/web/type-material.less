...
@button-background-color: contrast(@background, lighten(@background, 16%), darken(@background, 4%), 0.5);
@button-border-color: @button-background-color;
@button-gradient: null;
@button-shadow: 0px 2px 6px 0px rgba(0, 0, 0, 0.2);
@button-hover-text-color: @normal-text-color;
@button-hover-background-color: contrast(@background, lighten(@background, 24%), darken(@background, 8%), 0.5);
@button-hover-border-color: contrast(@background, lighten(@background, 24%), darken(@background, 8%), 0.5);
@button-hover-gradient: null;
@button-hover-shadow: 0 2px 6px rgba(0,0,0,.2), 0 2px 3px rgba(0,0,0,.05);
@button-active-text-color: contrast(@button-active-background);
@button-active-background: contrast(@background, lighten(@background, 24%), darken(@background, 16%), 0.5);
...
@button-focused-border-color: contrast(@background, lighten(@background, 24%), darken(@background, 20%), 0.5);
@button-focused-shadow: @button-hover-shadow;
@button-focused-active-color: @button-active-text-color;
@button-focused-active-background: @button-background-color;
...
@primary-shadow: 0px 2px 6px 0px rgba(0, 0, 0, 0.2);
@primary-hover-text-color: @primary-text-color;
@primary-hover-background-color: lighten(desaturate(@accent, 5%), 8%);
...
@primary-active-background-color: contrast(@background, lighten(saturate(@accent, 21%), 11%), darken(saturate(@accent, 10%), 11%), 0.5) ;
@primary-active-border-color: @primary-active-background-color;
@primary-active-gradient: null;
@primary-active-shadow: null;
@primary-focused-border-color: darken(saturate(@accent, 10%), 11%);
@primary-focused-gradient: null;
...
@tooltip-bg: rgba(100,100,100,.9);
@tooltip-text: #ffffff;
@tooltip-border: rgba(100,100,100,.9);
...
@toolbar-gradient: null;
@toolbar-shadow: @button-shadow;
...
@grid-sticky-border: contrast(@background, lighten(@grid-border, 30%), darken(@grid-border, 30%), 0.5);

@grid-selected-hover-bg: darken(@selected-background, 4%);
...
@calendar-cell-selected-bg: @accent;
@calendar-cell-selected-text: contrast(@calendar-cell-selected-bg);
@calendar-cell-selected-border: @calendar-cell-selected-bg;
...
@switch-on-bg: contrast(contrast(@background), lighten(@accent, 25%), lighten(@accent, 20%), 0.5);
@switch-on-text: white;
@switch-on-border: transparent;
...
@switch-on-hovered-bg: contrast(@background, lighten(@accent, 25%), lighten(@accent, 20%), 0.5);
@switch-on-hovered-text: @switch-on-text;
@switch-on-hovered-border: transparent;
@switch-on-hovered-gradient: null;

@switch-on-handle-bg: @accent;
@switch-on-handle-text: @switch-on-text;
@switch-on-handle-border: transparent;
@switch-on-handle-gradient: null;
@switch-on-handle-shadow: @box-shadow-depth-1;

@switch-on-handle-focused-bg: darken(@accent, 13%);
...
@switch-on-handle-hovered-bg: lighten(@accent, 9%);
@switch-on-handle-hovered-text: @switch-on-text;
@switch-on-handle-hovered-border: transparent;
@switch-on-handle-hovered-gradient: null;

@switch-off-bg: contrast(@background, darken(@background, 4%), lighten(@background, 27%), 0.5);
...
@switch-off-focused-bg: contrast(@background, darken(@background, 8%), lighten(@background, 9%), 0.5);
...
@switch-off-hovered-bg: contrast(@background, darken(@background, 8%), lighten(@background, 33%), 0.5);
...
@switch-off-handle-bg: contrast(@background, darken(@background, 2%), lighten(@background, 17%), 0.5);
@switch-off-handle-text: @switch-off-text;
@switch-off-handle-border: transparent;
@switch-off-handle-gradient: @button-gradient;
@switch-off-handle-shadow: @switch-on-handle-shadow;

@switch-off-handle-focused-bg: contrast(@background, darken(@background, 8%), lighten(@background, 23%), 0.5);
@switch-off-handle-focused-text: @switch-off-handle-text;
@switch-off-handle-focused-border: @switch-off-handle-border;
@switch-off-handle-focused-gradient: @switch-off-handle-gradient;

@switch-off-handle-hovered-bg: @switch-off-handle-focused-bg;
@switch-off-handle-hovered-text: @switch-off-text;
@switch-off-handle-hovered-border: @switch-off-handle-border;
@switch-off-handle-hovered-gradient: null;
...
// Adaptive Common
@adaptive-content-bg: @widget-background-color;
@adaptive-content-text: @accent;

@adaptive-menu-bg: @accent;
@adaptive-menu-text: @header-text-color;

@adaptive-menu-clear-text: @selected-text-color;
...
// Adaptive Grid
@adaptive-grid-sort-text: @selected-text-color;

// Adaptive Scheduler
@adaptive-scheduler-current-text: @header-text-color;
...
@badge-info-bg: contrast(@background, darken(@info, 30%), @info, 0.5);
@badge-info-text: contrast( @badge-info-bg );
@badge-info-border: @badge-info-bg;

@badge-success-bg: contrast(@background, darken(@success, 30%), @success, 0.5);
@badge-success-text: contrast( @badge-success-bg );
@badge-success-border: @badge-success-bg;

@badge-warning-bg: contrast(@background, darken(@warning, 30%), @warning, 0.5);
@badge-warning-text: contrast( @badge-warning-bg );
@badge-warning-border: @badge-warning-bg;

@badge-error-bg: contrast(@background, darken(@error, 30%), @error, 0.5);
...
@checkbox-border: contrast(@background, darken(@input-border, 15%), lighten(@input-border, 15%));
@checkbox-hovered-bg: @checkbox-bg;
@checkbox-hovered-text: @accent;
@checkbox-hovered-border: contrast(@background, darken(@checkbox-border, 15%), lighten(@checkbox-border, 15%));
@checkbox-checked-bg: @accent;
@checkbox-checked-text: contrast(@accent);
...
@filemanager-listview-item-icon-selected-text: @base;
...
@stepper-label-success-text: contrast(@base, lighten(@success, 1%), darken(@success, 10%));
...
@textarea-invalid-shadow: 0 0 0 1px @error;


// Appbar
@appbar-box-shadow: 0px 2px 3px rgba(0, 0, 0, .24);
@appbar-bottom-box-shadow:  0px -2px 3px rgba(0, 0, 0, .24);


//Gantt
@gantt-task-selected-bg: lighten(@selected-background, 20%);
@gantt-task-completed-selected-bg: @selected-background;
@gantt-summary-completed-selected-bg: @header-background-color;
...
.k-pager-wrap {
    ...
    .k-pager-numbers .k-state-selected:hover {
        border-top-color: @selected-text-color;
        color: @selected-text-color;
    }
...
.k-gantt .k-treelist tr.k-alt.k-state-selected,
.k-gantt .k-treelist tr.k-alt.k-state-selected > td
{
    background-color: @selected-background-color;
}
...
.k-toolbar {
    ...
    .k-button {
        .box-shadow( none );
        // background-color: shade( @button-background-color, 8% );
    }
...
.k-treelist tr.k-alt.k-state-selected,
.k-treelist tr.k-alt.k-state-selected > td
{
    background-color: @selected-background;
    border-color: @selected-background;
}
...
.k-time-list {
    ...
    &::after {
        @shadow-size: 3em;
        box-shadow: 0 0 @shadow-size (@shadow-size / 2) @widget-background-color;
    }
...
.k-dialog-button-group .k-button {
    box-shadow: none;
}
