...
TourService.ɵfac = function TourService_Factory(t) { return new (t || TourService)(ɵngcc0.ɵɵinject(Router)); };
TourService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: TourService, factory: TourService.ɵfac });
/** @nocollapse */
TourService.ctorParameters = () => [
    { type: Router }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TourService, [{
        type: Injectable
...
TourHotkeyListenerComponent.ɵfac = function TourHotkeyListenerComponent_Factory(t) { return new (t || TourHotkeyListenerComponent)(ɵngcc0.ɵɵdirectiveInject(TourService)); };
TourHotkeyListenerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TourHotkeyListenerComponent, selectors: [["tour-hotkey-listener"]], hostBindings: function TourHotkeyListenerComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keydown.Escape", function TourHotkeyListenerComponent_keydown_Escape_HostBindingHandler() { return ctx.onEscapeKey(); }, false, ɵngcc0.ɵɵresolveWindow)("keydown.ArrowRight", function TourHotkeyListenerComponent_keydown_ArrowRight_HostBindingHandler() { return ctx.onArrowRightKey(); }, false, ɵngcc0.ɵɵresolveWindow)("keydown.ArrowLeft", function TourHotkeyListenerComponent_keydown_ArrowLeft_HostBindingHandler() { return ctx.onArrowLeftKey(); }, false, ɵngcc0.ɵɵresolveWindow);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TourHotkeyListenerComponent, [{
        type: Component,
        args: [{
...
TourModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: TourModule });
TourModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TourModule_Factory(t) { return new (t || TourModule)(); }, imports: [[CommonModule, RouterModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TourModule, { declarations: function () { return [TourHotkeyListenerComponent]; }, imports: function () { return [CommonModule, RouterModule]; }, exports: function () { return [TourHotkeyListenerComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TourModule, [{
        type: NgModule,
        args: [{
