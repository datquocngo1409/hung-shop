...
function actionInternal() {
    ...
    return ((/** @type {?} */ (action$1))).apply(void 0, __spread$2(args));
}
/** @type {?} */
var action = (/** @type {?} */ (Object.assign(actionInternal, action$1)));
/**
 * @param {...?} args
 * @return {?}
 */
function computedInternal() {
    ...
    return ((/** @type {?} */ (computed$1))).apply(void 0, __spread$2(args));
}
/** @type {?} */
var computed = (/** @type {?} */ (Object.assign(computedInternal, computed$1)));
/**
 * @param {...?} args
 * @return {?}
 */
function observableInternal() {
    ...
    return ((/** @type {?} */ (observable$1))).apply(void 0, __spread$2(args));
}
/** @type {?} */
var observable = (/** @type {?} */ (Object.assign(observableInternal, observable$1)));
